...
export async function generateStaticParams() {
  return ["bon-plan", "test-gratuit", "test-avis", "test-produit", "comparatif", "beaute", "concours", "box-beaute", "calendrier", "calendrier-avent", "code-promo"].map((slug) => ({ slug }));
}
...
const categoryConfig: Record<string, { label: string; Icon: LucideIcon; desc: string; seoTitle: string; seoDesc: string; color: string }> = {
  ...
  "comparatif":       { label: "Comparatifs",             Icon: FlaskConical, desc: "Nos comparatifs et guides d'achat pour t'aider à choisir", seoTitle: "Comparatifs & Guides d'Achat : Bien Choisir en 2026", seoDesc: "Nos comparatifs et guides d'achat détaillés : lisseurs, robots aspirateurs, machines à glace, box beauté, sérums anti-âge, parfums… On teste et on tranche pour toi.", color: "test-avis" },
