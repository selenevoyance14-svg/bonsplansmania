...
const categoryConfig: Record<string, { label: string; Icon: LucideIcon; desc: string; seoTitle: string; seoDesc: string; color: string }> = {
  ...
  "test-gratuit":     { label: "Tests Gratuits",          Icon: Gift,         desc: "Des produits à tester gratuitement avant tout le monde", seoTitle: "Tests produits gratuits : produits à tester chez vous", seoDesc: "Recevez des produits gratuits à tester chez vous : beauté, bébé, alimentaire, animaux. Missions Trustt, Sampleo, ConsoBaby, Blissim et programmes de marques.", color: "test-gratuit" },
  "test-avis":        { label: "Tests & Avis",            Icon: FlaskConical, desc: "Nos tests et avis détaillés, produit par produit", seoTitle: "Tests et avis produit : nos essais détaillés", seoDesc: "Nos tests et avis produit, détaillés et argumentés : ce qu'on a aimé, ce qu'on a moins aimé, et pour qui c'est fait. Beauté, électroménager, puériculture.", color: "test-avis" },
  "comparatif":       { label: "Comparatifs",             Icon: FlaskConical, desc: "Nos comparatifs et guides d'achat pour t'aider à choisir", seoTitle: "Comparatifs et guides d'achat : bien choisir", seoDesc: "Nos comparatifs et guides d'achat détaillés : lisseurs, robots aspirateurs, machines à glace, box beauté, sérums anti-âge, parfums. Critères, prix et alternatives.", color: "test-avis" },
  ...
  "box-beaute":       { label: "Box Beauté",              Icon: ShoppingBag,  desc: "Tests et avis complets sur les box beauté du moment", seoTitle: "Box Beauté : Avis, Comparatifs et Bons Plans", seoDesc: "Comparez les meilleures box beauté : Blissim, Biotyfull Box et Lookfantastic. Retrouvez nos avis, contenus détaillés et codes promo du moment.", color: "box-beaute" },
...
const categoryIntros: Record<string, string> = {
  ...
  "comparatif": `<p>Nos <strong>comparatifs et guides d'achat</strong> t'aident à trancher entre plusieurs produits, plusieurs marques ou plusieurs modèles concurrents. Chaque comparatif est structuré autour de <strong>critères objectifs</strong> : prix, note Amazon, volume d'avis, spécifications techniques, points forts et points faibles réels.</p><p>Tu y trouveras deux types de contenus : les <strong>"meilleurs X 2026"</strong> (top 5-10 produits d'une catégorie, ex : meilleurs lisseurs, meilleurs sérums anti-âge, meilleures machines à glace) et les <strong>match 1 vs 1</strong> (comparatif direct entre deux modèles précis, ex : Ninja Creami vs Moulinex Dolci, Dyson Corrale vs Steampod, Blissim vs Biotyfull Box).</p><p>Nos comparatifs incluent systématiquement un <strong>tableau récapitulatif</strong>, une <strong>fiche par produit</strong>, un <strong>verdict par profil d'acheteur</strong> et une <strong>FAQ</strong>. Objectif : que tu ressortes de la page en sachant exactement quel produit acheter pour ton usage. Les liens Amazon et affiliés qui apparaissent nous rémunèrent sans surcoût pour toi.</p>`,
