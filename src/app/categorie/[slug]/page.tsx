...
const categoryConfig: Record<string, { label: string; Icon: LucideIcon; desc: string; seoTitle: string; seoDesc: string; color: string }> = {
  ...
  "beaute":           { label: "Guides Beauté",            Icon: Sparkles,     desc: "Tutos, guides et routines pour prendre soin de sa peau, ses cheveux et son bien-être", seoTitle: "Guides Beauté : Tutos, Routines & Conseils", seoDesc: "Tutos maquillage, routines skincare, guides huiles essentielles, cosmétiques maison, conseils bronzage. Tous nos guides pour bien prendre soin de soi.", color: "beaute" },
