                ...
                {active.map((a) => (
                  <a key={a.meta.slug} href={`/article/${a.meta.slug}`} className="card" style={{ textDecoration: "none" }}>
                    <div style={{ position: "relative", height: "180px", overflow: "hidden" }}>
                      <Image src={a.meta.image.toLowerCase().endsWith(".svg") ? "/images/articles/_placeholder-neutral.svg" : a.meta.image} alt={a.meta.imageAlt} fill style={{ objectFit: "cover" }} sizes="(max-width: 768px) 100vw, 33vw" loading="lazy" />
                    </div>
                ...
                <div className="articles-grid" style={{ marginTop: "16px" }}>
                  {expired.slice(0, 12).map((a) => (
                    <a key={a.meta.slug} href={`/article/${a.meta.slug}`} className="card" style={{ textDecoration: "none", opacity: 0.55, filter: "grayscale(40%)" }}>
                      ...
                      <div style={{ position: "relative", height: "160px", overflow: "hidden" }}>
                        <Image src={a.meta.image.toLowerCase().endsWith(".svg") ? "/images/articles/_placeholder-neutral.svg" : a.meta.image} alt={a.meta.imageAlt} fill style={{ objectFit: "cover" }} sizes="33vw" loading="lazy" />
                      </div>
                      <div className="card-body">
                        <h3 className="card-title">{a.meta.title}</h3>
                      </div>
