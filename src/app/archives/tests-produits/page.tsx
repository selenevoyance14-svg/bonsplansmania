...
import { Archive, ChevronRight, Gift } from "lucide-react";
...
export const metadata: Metadata = {
  title: "Archives des tests produits gratuits terminés",
  description: "Retrouvez les anciennes campagnes de tests produits gratuits publiées sur Bons Plans Mania, clairement signalées comme terminées.",
  alternates: { canonical: "https://bonsplansmania.fr/archives/tests-produits" },
};
...
export default function TestsProduitsArchivesPage() {
  const articles = getArchivedArticlesByCategory("test-gratuit");
        ...
        <section className="category-header">
          <div className="container">
            ...
            <h1 style={{ fontSize: "2rem", fontWeight: 800, marginBottom: "8px" }}>
              ...
              Archives des tests produits gratuits
            </h1>
            <p style={{ color: "var(--muted-foreground)", maxWidth: "760px" }}>
              Ces {articles.length} campagnes sont terminées. Leurs fiches restent consultables, mais les candidatures ne sont plus ouvertes.
            </p>
            <a href="/categorie/test-gratuit" className="btn btn-primary" style={{ marginTop: "16px" }}>
              <Gift size={15} /> Voir les tests gratuits en cours
            </a>
          </div>
        </section>
