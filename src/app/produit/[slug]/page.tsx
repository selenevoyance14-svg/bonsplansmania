...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  if (!product) return {};
  return {
    title: `${product.name} ${product.brand} : avis et comparateur de prix`,
    description: `${product.name} de ${product.brand} : avis court, marchands, prix constatés et offres disponibles.`,
