...
export const CODES_PERMANENTS_OFFERS: CodePromoOffer[] = [
  ...
  },
  {
    ...
    value: "-5 %",
    valueLabel: "EXTRA",
    title: "5 % EXTRA chez MiiN Cosmetics avec le code MIIN5",
    code: "MIIN5",
    permanent: true,
    conditions: "Saisir MIIN5 dans le panier. Une sélection Meisani et Ondo Beauty 36.5 bénéficie actuellement de 25 % de réduction. Vérifier l'application du code et les éventuelles exclusions avant le paiement.",
