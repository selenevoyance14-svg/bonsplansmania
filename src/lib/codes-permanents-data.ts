...
export const CODES_PERMANENTS_OFFERS: CodePromoOffer[] = [
  ...
  {
    id: "perm-blancheporte-bienvenue-899009",
    brandSlug: "blanche-porte",
    brandName: "Blancheporte",
    type: "code",
    value: "11 €",
    valueLabel: "DÈS 20 €",
    title: "11 € de réduction dès 20 € pour une première commande Blancheporte",
    code: "899009",
    permanent: true,
    featured: true,
    conditions: "Code de bienvenue réservé à une première commande mode ou maison. L'avantage est également proposé après inscription gratuite à la newsletter, selon les conditions reçues par e-mail. Non cumulable avec un autre code.",
  ...
  },
  {
    ...
    title: "iGraal : cashback et bonus de parrainage selon l'offre en cours",
    permanent: true,
    featured: true,
    conditions: "Inscription gratuite via le lien de parrainage. Le montant du bonus, les conditions de validation et les taux de cashback varient selon les offres affichées par iGraal.",
  ...
  },
  {
    ...
    value: "20 €",
    valueLabel: "OFFERTS",
    title: "20 € offerts dès 100 € d'achat sur la première commande Sarenza",
    permanent: true,
    featured: true,
    conditions: "Code de bienvenue reçu après inscription. Offre à usage unique, non cumulable, valable uniquement sur les articles vendus par Sarenza et hors cartes cadeaux Sarenza.",
