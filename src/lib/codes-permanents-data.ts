...
export const CODES_PERMANENTS_OFFERS: CodePromoOffer[] = [
  ...
  },
  {
    ...
    type: "offre",
    value: "-50 %",
    title: "Box bio Belle au Naturel à -50 % sur la 1ʳᵉ commande + 5 € parrainage",
    permanent: true,
    featured: true,
    conditions: "Parrainage : l'inviteur reçoit 5 € une fois la 1ʳᵉ box validée. Sans engagement. Livraison incluse.",
  ...
  },
  {
    ...
    type: "newsletter",
    value: "-20 %",
    title: "-20 % sur la 1ʳᵉ commande Clarins via newsletter + échantillons offerts",
    permanent: true,
    featured: true,
  ...
  },
  {
    ...
    type: "newsletter",
    value: "-15 %",
    title: "-15 % sur la 1ʳᵉ commande Uriage via newsletter (eau thermale, dermo-cosmétique)",
    permanent: true,
    conditions: "Inscription newsletter Uriage pour recevoir le code -15 %.",
  ...
  },
  {
    ...
    type: "newsletter",
    value: "-10 %",
    title: "-10 % sur la 1ʳᵉ commande Zooplus + programme fidélité zooPoints + parrainage 250 pts",
    permanent: true,
    conditions: "Inscription newsletter pour le -10 %. zooPoints cumulables sur chaque commande (paliers 200/500/2 000 points).",
