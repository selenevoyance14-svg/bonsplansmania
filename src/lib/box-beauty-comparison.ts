...
export const BOX_BEAUTY_COMPARISON: BoxBeautyComparisonItem[] = [
  ...
  },
  {
    ...
    formats: "9 produits grand format + 1 cabas ba&sh",
    idealFor: "Box magazines sans abonnement",
    offerName: "Rituel Signature Marie Claire",
    ...
    advantages: ["Achat ponctuel", "Valeur produits annoncée de 473,55 €", "Sélection in & out vérifiée le 25 août 2026"],
