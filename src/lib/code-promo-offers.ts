...
export const CODE_PROMO_OFFERS: CodePromoOffer[] = [
  ...
  // ============================================================
  // DARTY — vente flash GEM & TV du 31 août au 3 septembre 2026
  // ============================================================
  {
    id: "darty40-gem-tv-septembre-2026",
    brandSlug: "darty",
    type: "code",
    value: "40 €",
    valueLabel: "DÈS 400 €",
    title: "40 € de remise dès 400 € sur les TV et le gros électroménager",
    code: "DARTY40",
    starts: "2026-08-31",
    expires: "2026-09-03",
    conditions: "Valable du 31/08/2026 à 9 h au 03/09/2026 à 23 h 59 sur Darty.com, en magasin Darty et dans les franchises participantes. Téléviseurs, accessoires TV/Vidéo, accessoires gros électroménager et gros électroménager éligible des marques Bosch, Siemens, Neff, Candy, Haier, Rosières, Hisense, Samsung, LG, Whirlpool, La Sommelière, Climadiff, Avintage, Electrolux et AEG. Hors climatiseurs et produits Frigelux. Cumulable avec les promotions, hors offre utilisant un autre code avantage. Une utilisation de l'un des trois codes par client.",
    affiliateUrl: "https://www.awin1.com/cread.php?awinmid=7735&awinaffid=990397&ued=https%3A%2F%2Fwww.darty.com%2F",
    featured: true,
  },
  {
    id: "darty70-gem-tv-septembre-2026",
    brandSlug: "darty",
    type: "code",
    value: "70 €",
    valueLabel: "DÈS 700 €",
    title: "70 € de remise dès 700 € sur les TV et le gros électroménager",
    code: "DARTY70",
    starts: "2026-08-31",
    expires: "2026-09-03",
    conditions: "Valable du 31/08/2026 à 9 h au 03/09/2026 à 23 h 59 sur Darty.com, en magasin Darty et dans les franchises participantes. Téléviseurs, accessoires TV/Vidéo, accessoires gros électroménager et gros électroménager éligible des marques Bosch, Siemens, Neff, Candy, Haier, Rosières, Hisense, Samsung, LG, Whirlpool, La Sommelière, Climadiff, Avintage, Electrolux et AEG. Hors climatiseurs et produits Frigelux. Cumulable avec les promotions, hors offre utilisant un autre code avantage. Une utilisation de l'un des trois codes par client.",
  ...
  {
    id: "darty100-gem-tv-septembre-2026",
    brandSlug: "darty",
    type: "code",
    value: "100 €",
    valueLabel: "DÈS 1 000 €",
    title: "100 € de remise dès 1 000 € sur les TV et le gros électroménager",
    code: "DARTY100",
    starts: "2026-08-31",
    expires: "2026-09-03",
    conditions: "Valable du 31/08/2026 à 9 h au 03/09/2026 à 23 h 59 sur Darty.com, en magasin Darty et dans les franchises participantes. Téléviseurs, accessoires TV/Vidéo, accessoires gros électroménager et gros électroménager éligible des marques Bosch, Siemens, Neff, Candy, Haier, Rosières, Hisense, Samsung, LG, Whirlpool, La Sommelière, Climadiff, Avintage, Electrolux et AEG. Hors climatiseurs et produits Frigelux. Cumulable avec les promotions, hors offre utilisant un autre code avantage. Une utilisation de l'un des trois codes par client.",
  ...
  {
    id: "lookfantastic-shop-22-septembre-2026",
    brandSlug: "lookfantastic",
    type: "code",
    value: "-22 %",
    valueLabel: "3-5 SEPTEMBRE",
    ...
    starts: "2026-09-03",
    expires: "2026-09-05",
    conditions: "Code SHOP annoncé du 03/09/2026 au 05/09/2026 pour obtenir -22 % sur la sélection éligible. Exclusions et produits participants susceptibles d'évoluer ; vérifier la remise dans le panier.",
    featured: true,
  },
  {
    id: "lookfantastic-dimanche-30-septembre-6-2026",
    brandSlug: "lookfantastic",
    type: "code",
    value: "-30 %",
    valueLabel: "6 SEPTEMBRE",
    title: "Sunday Shopping : -30 % sur le prix conseillé avec DIMANCHE",
    code: "DIMANCHE",
    ...
    starts: "2026-09-06",
    expires: "2026-09-06",
    conditions: "Code DIMANCHE annoncé le 06/09/2026 pour obtenir -30 % sur le prix conseillé des produits sélectionnés. Des exclusions s'appliquent ; vérifier l'éligibilité dans le panier.",
    featured: true,
  },
  {
    id: "lookfantastic-lundi-25-septembre-7-2026",
    brandSlug: "lookfantastic",
    type: "code",
    value: "-25 %",
    valueLabel: "7 SEPTEMBRE",
    ...
    starts: "2026-09-07",
    expires: "2026-09-07",
    conditions: "Code LUNDI annoncé le 07/09/2026 pour obtenir -25 % sur la sélection Monday Shopping Extended. Exclusions et produits éligibles à vérifier dans le panier.",
    featured: true,
  },
  {
    ...
    starts: "2026-09-08",
    expires: "2026-09-12",
    conditions: "Code SALELF annoncé du 08/09/2026 au 12/09/2026 pour obtenir jusqu'à -30 % sur une sélection. Le taux dépend des produits ; exclusions et remise finale à vérifier dans le panier.",
    featured: true,
  },
  {
    ...
    starts: "2026-09-13",
    expires: "2026-09-13",
    conditions: "Code DIMANCHE annoncé le 13/09/2026 pour obtenir -30 % sur une sélection. La source partenaire mentionne par erreur août dans une programmation consacrée aux offres du 3 au 13 septembre. Exclusions à vérifier dans le panier.",
    featured: true,
  },
  {
  ...
  },
  {
    ...
    conditions: "Prix vérifié le 31 août 2026 : 36 € au lieu de 45 €, soit 20 % de remise, pour 7 produits d'une valeur annoncée supérieure à 145 €. Disponible et normalement expédiée sous 24 h ouvrables. Prix final et stock à vérifier.",
    featured: true,
  },
  {
