...
export const CODE_PROMO_OFFERS: CodePromoOffer[] = [
  ...
  // ============================================================
  // CDISCOUNT — offres post-soldes vérifiées le 29/07/2026
  // ============================================================
  {
    ...
    expires: "2026-08-02",
    featured: true,
    conditions: "Code CANAP50 valable sur une sélection de canapés Cdiscount jusqu'au 02/08/2026, dès 379 € d'achat. Vérifier l'éligibilité dans le panier.",
    affiliateUrl: "https://www.awin1.com/cread.php?awinmid=6948&awinaffid=990397&ued=https%3A%2F%2Fwww.cdiscount.com%2F",
  },
  {
    id: "cdiscount-50solaire",
    brandSlug: "cdiscount",
    type: "code",
    value: "-50 %",
    valueLabel: "SUR LE 2ᵉ",
    title: "2ᵉ produit solaire à -50 % sur une sélection",
    code: "50SOLAIRE",
    expires: "2026-08-03",
    conditions: "Code 50SOLAIRE valable jusqu'au 03/08/2026 sur une sélection solaire. La remise porte sur le deuxième article éligible ; vérifier son calcul dans le panier.",
    featured: true,
  },
  {
    id: "cdiscount-10sac39",
    brandSlug: "cdiscount",
    type: "code",
    value: "-10 %",
    valueLabel: "DÈS 39 €",
    title: "-10 % dès 39 € sur les sacs à dos, cartables et trousses",
    code: "10SAC39",
    expires: "2026-08-03",
    conditions: "Code 10SAC39 valable jusqu'au 03/08/2026 dès 39 € d'achat sur la sélection sacs à dos, cartables et trousses.",
    featured: true,
  },
  {
    ...
    value: "TOP DEALS",
    valueLabel: "ALERTES",
    title: "Alertes Cdiscount : les meilleurs prix sélectionnés jusqu'au 20 août",
    expires: "2026-08-20",
    conditions: "Sélection d'Alertes Cdiscount communiquée par Cdiscount x Awin, valable jusqu'au 20/08/2026. Prix susceptibles d'évoluer selon les stocks.",
  ...
  },
  {
    ...
    type: "code",
    value: "-10 %",
    valueLabel: "DÈS 79,99 €",
    title: "-10 % dès 79,99 € sur une sélection piscines et spas",
    code: "SPA10",
    expires: "2026-08-20",
    conditions: "Code SPA10 sur une sélection piscines et spas dès 79,99 € d'achat. Date de fin non précisée dans le message partenaire ; disponibilité affichée au plus tard jusqu'au 20/08/2026 par prudence.",
  },
  {
    id: "cdiscount-jouet499",
    brandSlug: "cdiscount",
    type: "code",
    value: "-10 %",
    valueLabel: "DÈS 499 €",
    title: "-10 % dès 499 € sur une sélection d'aires de jeux",
    code: "JOUET499",
    expires: "2026-08-20",
    conditions: "Code JOUET499 sur une sélection d'aires de jeux dès 499 € d'achat. Vérifier la disponibilité et l'éligibilité dans le panier.",
  },
  {
    ...
    code: "ELECTRO10D70",
    expires: "2026-08-20",
    conditions: "Code ELECTRO10D70 sur une sélection de petit électroménager dès 70 € d'achat. Vérifier la disponibilité et l'éligibilité dans le panier.",
  },
  {
    ...
    code: "MEUBLES10",
    expires: "2026-08-20",
    conditions: "Code MEUBLES10 sur une sélection de meubles dès 79 € d'achat. Vérifier la disponibilité et l'éligibilité dans le panier.",
  },
  {
    id: "cdiscount-15lit",
    brandSlug: "cdiscount",
    type: "code",
    value: "-15 %",
    valueLabel: "DÈS 129,99 €",
    title: "-15 % dès 129,99 € sur une sélection literie",
    code: "15LIT",
    expires: "2026-08-20",
    conditions: "Code 15LIT sur une sélection literie dès 129,99 € d'achat. Vérifier la disponibilité et l'éligibilité dans le panier.",
  },
  {
    id: "cdiscount-m4h15",
    brandSlug: "cdiscount",
    ...
    code: "M4H15",
    expires: "2026-08-20",
    conditions: "Code M4H15 sur une sélection Made 4 Home dès 49,99 € d'achat. Vérifier la disponibilité et l'éligibilité dans le panier.",
  },
  {
    ...
    code: "10MOB449",
    expires: "2026-08-20",
    conditions: "Code 10MOB449 sur une sélection mobilité urbaine dès 449 € d'achat. Vérifier la disponibilité et l'éligibilité dans le panier.",
  },
