...
export const CODE_PROMO_OFFERS: CodePromoOffer[] = [
  ...
  // ============================================================
  // CDISCOUNT — offres communiquées le 08/09/2026
  // ============================================================
  {
    id: "cdiscount-cocorico15",
    brandSlug: "cdiscount",
    type: "code",
    value: "-15 €",
    valueLabel: "DÈS 129 €",
    title: "-15 € dès 129 € d'achat pendant les French Days",
    code: "COCORICO15",
    expires: "2026-09-14",
    featured: true,
    conditions: "Code valable jusqu'au 14 septembre 2026 à 23h59 sur les produits éligibles. Vérifier l'application de la remise dans le panier.",
    affiliateUrl: "https://www.awin1.com/cread.php?awinmid=6948&awinaffid=990397&ued=https%3A%2F%2Fwww.cdiscount.com%2F",
  },
  {
    id: "cdiscount-literie199",
    brandSlug: "cdiscount",
    type: "code",
    value: "-25 €",
    valueLabel: "DÈS 199 €",
    title: "-25 € dès 199 € sur la literie éligible",
    code: "LITERIE199",
    expires: "2026-09-17",
    conditions: "Code valable jusqu'au 17 septembre 2026 sur la sélection literie éligible. Vérifier les conditions dans le panier.",
    affiliateUrl: "https://www.awin1.com/cread.php?awinmid=6948&awinaffid=990397&ued=https%3A%2F%2Fwww.cdiscount.com%2F",
  },
  {
  ...
  },
  {
    ...
    value: "-5 €",
    valueLabel: "DÈS 25 €",
    title: "-5 € dès 25 € sur la sélection Monbento",
    code: "MBT10",
    expires: "2026-09-15",
    conditions: "Code valable jusqu'au 15 septembre 2026 sur la sélection Monbento éligible. Vérifier les conditions dans le panier.",
    affiliateUrl: "https://www.awin1.com/cread.php?awinmid=6948&awinaffid=990397&ued=https%3A%2F%2Fwww.cdiscount.com%2F",
  },
  {
    id: "cdiscount-rentree-septembre-2026",
    brandSlug: "cdiscount",
    type: "offre",
    value: "JUSQU'À -40 %",
    title: "Jusqu'à -40 % sur la sélection rentrée",
    expires: "2026-09-17",
    conditions: "Remises affichées sur une sélection rentrée jusqu'au 17 septembre 2026, dans la limite des stocks disponibles.",
    affiliateUrl: "https://www.awin1.com/cread.php?awinmid=6948&awinaffid=990397&ued=https%3A%2F%2Fwww.cdiscount.com%2F",
  },
