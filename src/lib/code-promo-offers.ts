...
export const CODE_PROMO_OFFERS: CodePromoOffer[] = [
  { id: "miin-meisani-ondo-25-miin5", brandSlug: "miin-cosmetics", type: "code", value: "-25 %", valueLabel: "+ 5 % EXTRA", title: "25 % sur Meisani et Ondo Beauty 36.5 + 5 % EXTRA", code: "MIIN5", conditions: "Réduction de 25 % sur la sélection Meisani et Ondo Beauty 36.5. Saisir le code MIIN5 dans le panier pour obtenir 5 % EXTRA sur la commande éligible. Vérifier l'application et les éventuelles exclusions avant le paiement.", featured: true },
