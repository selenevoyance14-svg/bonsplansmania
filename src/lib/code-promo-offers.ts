...
export const CODE_PROMO_OFFERS: CodePromoOffer[] = [
  ...
  // ============================================================
  {
    id: "lookfantastic-salelf-septembre-2026",
    brandSlug: "lookfantastic",
    type: "code",
    value: "-30 %",
    valueLabel: "11-12 SEPTEMBRE",
    title: "Jusqu'à -30 % sur une sélection avec le code SALELF",
    code: "SALELF",
    ...
    starts: "2026-09-08",
    expires: "2026-09-12",
    conditions: "Code SALELF valable jusqu'au 12/09/2026 pour obtenir jusqu'à -30 % sur la sélection liée. Le taux dépend des produits ; exclusions et remise finale à vérifier dans le panier.",
    featured: true,
  },
  {
    id: "lookfantastic-dimanche-30-septembre-13-2026",
    brandSlug: "lookfantastic",
    type: "code",
    value: "-30 %",
    valueLabel: "13 SEPTEMBRE",
    title: "Sunday Shopping : -30 % sur une sélection avec DIMANCHE",
    code: "DIMANCHE",
    ...
    starts: "2026-09-13",
    expires: "2026-09-13",
    conditions: "Code DIMANCHE valable le 13/09/2026 pour obtenir -30 % sur la sélection Sunday Shopping. Exclusions et produits participants à vérifier dans le panier.",
    featured: true,
  },
  {
    id: "lookfantastic-lundi-25-septembre-14-2026",
    brandSlug: "lookfantastic",
    type: "code",
    value: "-25 %",
    valueLabel: "14 SEPTEMBRE",
    title: "Monday Shopping Extended : -25 % avec le code LUNDI",
    code: "LUNDI",
    ...
    starts: "2026-09-14",
    expires: "2026-09-14",
    conditions: "Code LUNDI valable le 14/09/2026 pour obtenir -25 % sur la sélection Monday Shopping Extended. Exclusions et produits éligibles à vérifier dans le panier.",
    featured: true,
  },
  {
    id: "lookfantastic-shop-22-septembre-15-19-2026",
    brandSlug: "lookfantastic",
    type: "code",
    value: "-22 %",
    valueLabel: "15-19 SEPTEMBRE",
    title: "-22 % sur une sélection avec SHOP, prix appli jusqu'à -40 %",
    code: "SHOP",
    ...
    starts: "2026-09-15",
    expires: "2026-09-19",
    conditions: "Code SHOP valable du 15/09/2026 au 19/09/2026 pour obtenir -22 % sur la sélection liée. Des prix dans l'application allant jusqu'à -40 % sont également annoncés. Exclusions à vérifier.",
    featured: true,
  },
  {
    id: "lookfantastic-dimanche-30-septembre-20-2026",
    brandSlug: "lookfantastic",
    type: "code",
    value: "-30 %",
    valueLabel: "20 SEPTEMBRE",
    title: "Sunday Shopping : -30 % sur une sélection avec DIMANCHE",
    code: "DIMANCHE",
    affiliateUrl: "https://www.awin1.com/cread.php?awinmid=7496&awinaffid=990397&ued=https%3A%2F%2Fwww.lookfantastic.fr%2Fc%2Foffers%2Feu%2Fsunday-shopping%2Ffr%2F",
    starts: "2026-09-20",
    expires: "2026-09-20",
    conditions: "Code DIMANCHE valable le 20/09/2026 pour obtenir -30 % sur la sélection Sunday Shopping. Exclusions et produits participants à vérifier dans le panier.",
    featured: true,
  },
  {
    id: "lookfantastic-color-wow-traitements-septembre-2026",
    brandSlug: "lookfantastic",
    type: "offre",
    value: "-30 %",
    valueLabel: "COLOR WOW",
    title: "-30 % sur une sélection de soins Color Wow",
    ...
    starts: "2026-09-07",
    expires: "2026-09-13",
    conditions: "Remise de 30 % annoncée sur une sélection de soins Color Wow jusqu'au 13/09/2026. Produits participants et prix susceptibles d'évoluer.",
    featured: true,
  },
  {
  ...
  },
  {
    ...
    conditions: "Édition Nouvelle Saison annoncée à 50 € pour une valeur supérieure à 122 €. Prix et stock à vérifier sur la fiche produit.",
    featured: true,
  },
  {
  ...
  {
    id: "cdiscount-tel25d199",
    brandSlug: "cdiscount",
    type: "code",
    value: "-25 €",
    valueLabel: "DÈS 199 €",
    title: "-25 € dès 199 € sur une sélection téléphonie",
    code: "TEL25D199",
    conditions: "Code TEL25D199 annoncé disponible tant que l'offre reste visible sur Cdiscount, dès 199 € d'achat sur les articles éligibles de la sélection téléphonie. Vérifier la remise dans le panier.",
    affiliateUrl: "https://www.awin1.com/cread.php?awinmid=6948&awinaffid=990397&ued=https%3A%2F%2Fwww.cdiscount.com%2F",
    featured: true,
  },
  {
