...
export const CODE_PROMO_OFFERS: CodePromoOffer[] = [
  ...
  // ============================================================
  // YESSTYLE — Early Back to School, vérifié le 28/07/2026
  // ============================================================
  {
    id: "yesstyle-early-back-to-school",
    brandSlug: "yesstyle",
    type: "soldes",
    value: "-50 %",
    valueLabel: "K-BEAUTY",
    title: "Early Back to School : jusqu'à -50 % sur une sélection beauté",
    ...
    expires: "2026-08-02",
    conditions: "Campagne YesStyle annoncée du 27/07 au 02/08/2026. Jusqu'à -50 % sur une sélection beauté : le niveau de remise varie selon les marques et les produits.",
    featured: true,
  },
  {
    id: "yesstyle-bts26",
    ...
    value: "-15 %",
    valueLabel: "EN PLUS",
    title: "Jusqu'à -15 % supplémentaires avec le code BTS26",
    code: "BTS26",
    affiliateUrl: "https://www.awin1.com/cread.php?awinmid=15447&awinaffid=990397&ued=https%3A%2F%2Fwww.yesstyle.com%2Ffr%2Fbeauty-beauty%2Flist.html%2Fbcc.15478_bpt.46%3Fsb%3D165",
    expires: "2026-07-31",
    conditions: "Code annoncé du 28/07 au 31/07/2026, offrant jusqu'à -15 % supplémentaires. Le pourcentage dépend du panier et des conditions affichées par YesStyle.",
    featured: true,
  },
  {
    id: "yesstyle-26ready",
    ...
    value: "-15 %",
    valueLabel: "EN PLUS",
    title: "Jusqu'à -15 % supplémentaires avec le code 26READY",
    code: "26READY",
    affiliateUrl: "https://www.awin1.com/cread.php?awinmid=15447&awinaffid=990397&ued=https%3A%2F%2Fwww.yesstyle.com%2Ffr%2Fbeauty-beauty%2Flist.html%2Fbcc.15478_bpt.46%3Fsb%3D165",
    expires: "2026-08-04",
    conditions: "Code annoncé du 31/07 au 04/08/2026, offrant jusqu'à -15 % supplémentaires. Le pourcentage dépend du panier et des conditions affichées par YesStyle.",
    featured: true,
  },
  {
    id: "yesstyle-purito-seoul-50",
    brandSlug: "yesstyle",
    type: "offre",
    value: "-50 %",
    valueLabel: "PURITO SEOUL",
    title: "Jusqu'à -50 % sur la sélection de soins Purito SEOUL",
    affiliateUrl: "https://www.awin1.com/cread.php?awinmid=15447&awinaffid=990397&ued=https%3A%2F%2Fwww.yesstyle.com%2Ffr%2Fpurito-seoul%2Flist.html%2Fbpt.299_bid.321913%3Fsb%3D165",
    expires: "2026-08-02",
    conditions: "Remise annoncée sur une sélection Purito SEOUL du 27/07 au 02/08/2026. Vérifier le prix final et les produits concernés sur YesStyle.",
  },
  {
    id: "yesstyle-by-wishtrend-50",
    brandSlug: "yesstyle",
    type: "offre",
    value: "-50 %",
    valueLabel: "BY WISHTREND",
    title: "Jusqu'à -50 % sur la sélection de soins By Wishtrend",
    affiliateUrl: "https://www.awin1.com/cread.php?awinmid=15447&awinaffid=990397&ued=https%3A%2F%2Fwww.yesstyle.com%2Ffr%2Fby-wishtrend%2Flist.html%2Fbpt.299_bid.319236%3Fsb%3D165",
    expires: "2026-08-02",
    conditions: "Remise annoncée sur une sélection By Wishtrend du 27/07 au 02/08/2026. Vérifier le prix final et les produits concernés sur YesStyle.",
  },
  {
    id: "yesstyle-numbuzin-40",
    brandSlug: "yesstyle",
    type: "offre",
    value: "-40 %",
    valueLabel: "NUMBUZIN",
    title: "Jusqu'à -40 % sur la sélection de soins numbuzin",
    affiliateUrl: "https://www.awin1.com/cread.php?awinmid=15447&awinaffid=990397&ued=https%3A%2F%2Fwww.yesstyle.com%2Ffr%2Fnumbuzin%2Flist.html%2Fbpt.299_bid.326359%3Fsb%3D165",
    expires: "2026-08-02",
    conditions: "Remise annoncée sur une sélection numbuzin du 27/07 au 02/08/2026. Vérifier le prix final et les produits concernés sur YesStyle.",
  },
