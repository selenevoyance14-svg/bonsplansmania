/* eslint-disable */
// Generated by Wrangler by running `wrangler types workers/alerts/src/worker-configuration.d.ts --config workers/alerts/wrangler.jsonc` (hash: af71a5cbe1057f1eb95112ed6b6ac6e9)
// Runtime types generated with workerd@1.20260415.1 2026-09-09 nodejs_compat
declare namespace Cloudflare {
	...
	interface Env {
		ALERTS: KVNamespace;
		FROM_EMAIL: "alertes@bonsplansmania.fr";
		FROM_NAME: "Bons Plans Mania";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "FROM_EMAIL" | "FROM_NAME" | "SITE_URL">> {}
}
